...
class _EditDeptState extends State<EditDept> {
  ...
  Future<void> readDepartment() async {
    ...
    String urlDV =
        'https://nottinhere.com/demo/stap/api/json_data_department.php&selectId=$selectId';
  ...
  Future<void> submitThread() async {
    ...
    try {
      String url =
          'https://nottinhere.com/demo/stap/api/json_submit_manage_department.php?memberId=$memberID&selectId=$selectId&action=edit&name=$txtname'; //'';
      print('submitURL >> $url');
